...
-(id)initWithFloat:(CGFloat )mfloat
{
    ...
    if (self) {
        ...
        if (mfloat > 480 ) {
            ...
            self.tiMuLabd.frame = CGRectMake(5, -5, 220, 30);
            self.tiMuLabd.textAlignment = NSTextAlignmentLeft;
            self.tiMuLabd.textColor = [UIColor blackColor];
            self.tiMuLabd.font = [UIFont fontWithName:@"Arial" size:18];
            ...
            self.myTableView = [[UITableView alloc] initWithFrame:CGRectMake(5, 143, 300, 240) style:UITableViewStylePlain];
...
//            [self addSubview:self.huiFuBtn];
            ...
            */          
            ...
            self.tiMuLabd = [[UILabel alloc] init];
            self.tiMuLabd.frame = CGRectMake(5, 0, 220, 30);
            self.tiMuLabd.textAlignment = NSTextAlignmentLeft;
            self.tiMuLabd.textColor = [UIColor blackColor];
            self.tiMuLabd.font = [UIFont fontWithName:@"Arial" size:18];
            self.tiMuLabd.backgroundColor = [UIColor clearColor];
            ...
            self.myTableView = [[UITableView alloc] initWithFrame:CGRectMake(5, 97, 300, 220) style:UITableViewStylePlain];
            self.myTableView.tag = 1001;
            //  [self.myTableView setSeparatorStyle:UITableViewCellSeparatorStyleNone];
            [self addSubview:self.myTableView];
