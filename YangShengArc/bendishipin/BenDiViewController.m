...
//    NSDirectoryEnumerator * myDirectory = [fm enumeratorAtPath:[[NSBundle mainBundle] bundlePath]];
    ...
    if (mp4array.count == 0) {
        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"Prompt:" message:@"No local video" delegate:self cancelButtonTitle:@"Cancel" otherButtonTitles:nil, nil];
...
-(UITableViewCell * )tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.nameMp4ary.count >1 ) {
        ...
        cell.nameLabel.text = @"Health exercises video";
    }
